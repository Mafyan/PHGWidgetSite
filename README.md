...
Если `start_date`/`end_date` не переданы, сервис вернёт расписание **на 4 недели вперёд** от текущего момента.
...
Можно НЕ задавать `data-start-date` / `data-end-date` — тогда виджет загрузит расписание **на 4 недели вперёд** автоматически.
